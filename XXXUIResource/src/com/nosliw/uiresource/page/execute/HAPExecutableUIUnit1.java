...
public class HAPExecutableUIUnit1 extends HAPExecutableImp{
	...
	protected HAPExecutableUIUnit1 m_parent;
	...
	private HAPExecutableUIUnit m_body;

	public HAPExecutableUIUnit1(HAPDefinitionUIUnit uiUnitDefinition, String id) {
		...
		this.m_body = new HAPExecutableUIUnit(this.m_uiUnitDefinition, this);
	}
	...
	public HAPExecutableUIUnit getBody() {   return this.m_body;   }
	
	public HAPDefinitionUIUnit getUIUnitDefinition() {	return this.m_uiUnitDefinition;	}
	
	public HAPExecutableUIUnit1 getParent() {  return this.m_parent;   }
	public void setParent(HAPExecutableUIUnit1 parent) {		this.m_parent = parent;	}
