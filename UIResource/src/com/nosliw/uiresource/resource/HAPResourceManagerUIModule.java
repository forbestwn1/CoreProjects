...
public class HAPResourceManagerUIModule  extends HAPResourceManagerImp{
	...
	public HAPResource getResource(HAPResourceId resourceId, HAPRuntimeInfo runtimeInfo) {
		HAPResourceIdUIModule uiModuleId = new HAPResourceIdUIModule((HAPResourceIdSimple)resourceId); 
		HAPExecutableModule uiModule = this.m_uiResourceMan.getUIModule(uiModuleId.getIdLiterate(), new HAPAttachmentContainer(resourceId.getSupplement()));
