...
public class HAPUITagQueryResultInfo  extends HAPSerializableImp{
	...
	private HAPUITagQueryResult m_result;
	
	private double m_score;
	
	public HAPUITagQueryResultInfo(HAPUITagQueryResult result, double score) {
		this.m_result = result;
		this.m_score = score;
	}
	
	public HAPUITagQueryResult getResult() {    return this.m_result;    }
