...
public class HAPProcessorUICommand {
	...
	public static void processCommand(HAPExecutableUIUnit uiExe, HAPRuntimeEnvironment runtimeEnv) {
		...
		for(HAPDefinitionCommand commandDef : commandsDef) {
			HAPExecutableCommand commandExe = HAPProcessorCommand.process(commandDef, HAPContainerStructure.createDefault(uiExe.getBody().getValueStructureDefinitionNode().getValueStructureWrapper().getValueStructure()), runtimeEnv);
