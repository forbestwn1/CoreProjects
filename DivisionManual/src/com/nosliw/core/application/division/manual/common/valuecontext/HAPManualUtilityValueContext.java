...
public class HAPManualUtilityValueContext {
	...
	public static List<HAPManualInfoValueStructureSorting> getAllValueStructuresSorted(HAPValueContext valueContext){
		List<HAPManualInfoValueStructureSorting> out = getAllValueStructures(valueContext);
		sortValueStructureInfos(out);
		return out;
	}
	
	public static List<HAPManualInfoValueStructureSorting> getAllValueStructures(HAPValueContext valueContext){
