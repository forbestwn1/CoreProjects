...
public class HAPUtilityBrickLocation {
	...
	public static HAPManualInfoBrickLocation getEntityLocationInfo(HAPIdBrick entityId) {
		return getEntityLocationInfo(HAPSystemFolderUtility.getManualEntityBaseFolder(), entityId);
	}

	public static HAPManualInfoBrickLocation getLocalEntityLocationInfo(String basePath, HAPIdBrick entityId) {
		return getEntityLocationInfo(basePath, entityId);
	}

	private static HAPManualInfoBrickLocation getEntityLocationInfo(String basePath, HAPIdBrick entityId) {
		...
		if(result!=null) {
			return new HAPManualInfoBrickLocation(result.getLeft(), result.getRight(), new HAPPathLocationBase(basePath));
		}
		else {
	...
	private static HAPManualInfoBrickLocation getEntityLocationInfo(String basePath, String id) {
		...
		if(result!=null) {
			return new HAPManualInfoBrickLocation(result.getLeft(), result.getRight(), new HAPPathLocationBase(newBasePath));
		}
		else {
