...
public class HAPManualDefinitionScriptExpression extends HAPSerializableImp{
	...
	public HAPManualDefinitionScriptExpression() {
	}

	public HAPManualDefinitionScriptExpression(String scriptExpressionStr) {
		this(scriptExpressionStr, null);
	}
	
	public HAPManualDefinitionScriptExpression(String scriptExpressionStr, String scriptExpressionType) {
