...
var node_createModuleRuntimeRequest = function(uiModuleDef, statelessData, decorations, envFactory, handlers, request){
	...
	out.addRequest(node_createUIModuleRequest(uiModuleDef, statelessData, decorations, {
...
packageObj.createChildNode("createModuleRuntimeRequest1", node_createModuleRuntimeRequest); 
