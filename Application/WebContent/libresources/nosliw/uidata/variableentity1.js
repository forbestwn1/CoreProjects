...
packageObj.createChildNode("OrderedContainerElementInfo1", node_OrderedContainerElementInfo); 
packageObj.createChildNode("createVariableWrapper1", node_createVariableWrapper); 
packageObj.createChildNode("createOrderedContainersInfo1", node_createOrderedContainersInfo); 
packageObj.createChildNode("createOrderVariableContainer1", node_createOrderVariableContainer); 
