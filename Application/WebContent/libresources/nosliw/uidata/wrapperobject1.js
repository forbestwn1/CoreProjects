...
var node_createWraperObject = function(){
	...
	var loc_out = {		
			...
			getDataOperationRequest : function(baseValue, dataOperation, handler, requester_parent){
...
nosliw.registerSetNodeDataEvent("uidata.wrapper.wrapperFactory1", function(){
...
packageObj.createChildNode("createWraperObject1", node_createWraperObject); 
