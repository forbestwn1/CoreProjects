	...
	var loc_getRuleValidationRequest = function(data, rule, handlers, request){
		...
		if(ruleType==node_COMMONCONSTANT.DATARULE_TYPE_ENUM){
			...
			if(validationExpression!=undefined){
				...
				return nosliw.runtime.getExpressionService().getExecuteExpressionRequest(validationExpression, undefined, variableValue, undefined, undefined, {
...
nosliw.registerSetNodeDataEvent("request.request.utility", function(){node_requestUtility = this.getData();});

//Register Node by Name
packageObj.createChildNode("dataRuleUtility2", node_utility); 
