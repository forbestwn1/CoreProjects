...
var node_createSimpleEntityContainerPlugin = function(){
	...
	var loc_out = {
		...
		getCreateComplexEntityCoreRequest : function(complexEntityDef, valueContextId, bundleCore, configure, handlers, request){
			return node_createServiceRequestInfoSimple(undefined, function(request){
				return loc_createSimpleEntityContainerComponentCore(complexEntityDef, valueContextId, bundleCore, configure);
			}, handlers, request);
		},
	};
...
var loc_createSimpleEntityContainerComponentCore = function(complexEntityDef, valueContextId, bundleCore, configure){
...
packageObj.createChildNode("createSimpleEntityContainerPlugin", node_createSimpleEntityContainerPlugin); 
