...
"id":"*complexscript_debug_bricktreeinbundle"
},
"children":[],
"dependency":{},
"info":{}
	...
	var loc_out = {
		...
		updateView : function(view){
			...
			var trigueView = $('<button>check bricktreeinbundle</button>');
			...
			trigueView.click(function() {
				resultView.val(JSON.stringify(node_UtilityDebug.exportBundle(loc_bundleCore)));		
			});
		},
	};
