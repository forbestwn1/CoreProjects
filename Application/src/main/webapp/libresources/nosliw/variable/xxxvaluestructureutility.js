...
var node_utility = function(){
	...
	var loc_out = {
		...
		//					if(contextDefRootEle[node_COMMONATRIBUTECONSTANT.CONTEXTDEFINITIONELEMENT_ISTOPARENT]==true){
								...
								valueStructureElementInfosArray.push(node_createValueStructureElementInfo(eleName, parentValueContext, node_createValueStructureVariableInfo(rootName, path), undefined, info));
							}
						}
						else{
		...
		//				if(type==node_COMMONCONSTANT.CONTEXT_ELEMENTTYPE_RELATIVE && contextDefRootEle[node_COMMONATRIBUTECONSTANT.CONTEXTDEFINITIONELEMENT_ISTOPARENT]==false){
							...
							if(valueStructure.getContextElement(rootName)!=undefined){
								valueStructure.addContextElement(node_createValueStructureElementInfo(eleName, context, node_createValueStructureVariableInfo(rootName, path), undefined, info));
							}
						}
					}
				});	
