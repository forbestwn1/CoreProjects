		...
		success : function(requestInfo, resources){
			...
			var uiTag = node_createUITag(
					...
					parentUIResourceView!=undefined?parentUIResourceView.getContext():undefined,
					{
						...
						contextDef : uiTagResource[node_COMMONATRIBUTECONSTANT.EXECUTABLEUIUNIT_TAGVALUESTRUCTURE],
...
//						bodyContextDef : uiTagResource[node_COMMONATRIBUTECONSTANT.EXECUTABLEUIUNIT_BODYUNIT],
//						bodyContextDef : uiTagResource[node_COMMONATRIBUTECONSTANT.EXECUTABLEUIUNIT_BODYUNIT][node_COMMONATRIBUTECONSTANT.EXECUTABLEUIBODY_CONTEXT][node_COMMONATRIBUTECONSTANT.CONTEXTFLAT_CONTEXT][node_COMMONATRIBUTECONSTANT.CONTEXT_ELEMENT],
						bodyContextDef : uiTagResource[node_COMMONATRIBUTECONSTANT.EXECUTABLEUIUNIT_BODYUNIT][node_COMMONATRIBUTECONSTANT.EXECUTABLEUIBODY_VALUESTRUCTURE],
						eventNameMapping : uiTagResource[node_COMMONATRIBUTECONSTANT.EXECUTABLEUIUNIT_EVENTMAPPING],
						varNameMapping : uiTagResource[node_COMMONATRIBUTECONSTANT.EXECUTABLEUIUNIT_TAGVALUESTRUCTURE][node_COMMONATRIBUTECONSTANT.CONTEXTFLAT_LOCAL2GLOBAL],
...
//			loc_context = node_contextUtility.buildContextFromFlat("View_"+id, loc_uiBody[node_COMMONATRIBUTECONSTANT.EXECUTABLEUIBODY_CONTEXT], parentContext);
			loc_context = node_contextUtility.buildContext("View_"+id, loc_uiBody[node_COMMONATRIBUTECONSTANT.EXECUTABLECOMPONENT_VALUESTRUCTURE][node_COMMONATRIBUTECONSTANT.EXECUTABLEVALUESTRUCTURE_ROOT], parentContext);
		}
...
//		},
		...
		getDataOperationSet : function(target, path, value, dataTypeInfo){  return new node_ValueInVarOperation(target, node_valueInVarOperationServiceUtility.createSetOperationService(path, value, dataTypeInfo)); },
		getDataOperationRequestSet : function(target, value, dataTypeInfo, handlers, request){	return node_createValueInVarOperationRequest(loc_context, this.getDataOperationSet(target, undefined, value, dataTypeInfo), handlers, request);	},
