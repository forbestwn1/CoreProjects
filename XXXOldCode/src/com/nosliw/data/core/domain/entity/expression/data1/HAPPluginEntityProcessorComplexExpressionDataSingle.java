...
public class HAPPluginEntityProcessorComplexExpressionDataSingle extends HAPPluginProcessorBrickDefinitionComplexImp{
	...
	public void processValueContext(HAPExecutableEntityComplex complexEntityExecutable, HAPContextProcessor processContext) {
		...
		executableExpresion.setExpression(new HAPExecutableExpressionData1(definitionExpression.getExpression()));
