...
public class HAPUtilityValueContextReference {
	...
	public static HAPIdElement resolveVariableReference(HAPReferenceElement reference, Set<String> groupType, HAPExecutableEntityValueContext valueContext, HAPDomainValueStructure valueStructureDomain, HAPConfigureResolveElementReference resolveConfigure){
		...
		return new HAPIdElement(rootEleId, reference.getLeafPath());
	}
