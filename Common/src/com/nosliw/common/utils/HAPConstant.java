...
public class HAPConstant {
		...
		public static final String CONS_TESTRESULT_TYPE_ITEM = "ITEM";



		public static final String CONS_TEST_TYPE_SUITE = "SUITE";
		public static final String CONS_TEST_TYPE_CASE = "CASE";
		public static final String CONS_TEST_TYPE_ITEM = "ITEM";
		...
		public static final String CONS_STRINGABLE_BASICVALUETYPE_STRING = "string";
