...
public class HAPInstanceModule  extends HAPSerializableImp{
	...
	public HAPInstanceModule(HAPUIModuleEntry moduleEntry) {
	...
	protected boolean buildObjectByFullJson(Object json){
		...
		this.m_service =  HAPSerializeUtility.buildMapFromJsonObject(HAPDefinitionService.class.getName(), jsonObj.optJSONObject(SERVICE));
