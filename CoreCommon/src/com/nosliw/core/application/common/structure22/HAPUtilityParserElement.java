...
import com.nosliw.core.application.common.structure.HAPElementStructureLeafRuntime;
	...
	public static HAPElementStructure parseStructureElement(JSONObject eleDefJson) {
		...
		if(defRefObj!=null) {
			...
			if(provideObj instanceof String) {
				...
				if(defJsonObj!=null) {
					provideElement.setDefinition(HAPUtilityParserElement.parseStructureElement(defJsonObj));
				}
			}
			out = provideElement;
		}
