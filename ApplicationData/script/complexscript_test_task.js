		...
		updateView : function(view){
			...
			_.each(loc_events, function(event, i){
				...
				eventTrigueView.click(function() {
					...
					var taskContext = {
						getInitRequest : function(coreEntity, handlers, request){
					...
					var taskExeRequest = node_taskUtility.getExecuteTaskRequest(handlerEntityCore, taskContext, handlers, request)
