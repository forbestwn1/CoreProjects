...
nosliw.runtime.getResourceService().importResource({"id":{"id":"price",
"type":"uiTag"
},
"children":[],
...
function (env) {
    ...
    var loc_getViewData = function () {
        ...
        return {dataTypeId: "test.price;1.0.0", value: {currency: value.substring(0, 1), price: value.substring(1)}};
    };
