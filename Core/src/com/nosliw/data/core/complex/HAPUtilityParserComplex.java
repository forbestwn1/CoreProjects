...
public class HAPUtilityParserComplex {
	...
	public static void parseAttachmentInComplex(HAPIdEntityInDomain complexEntityId, JSONObject entityJsonObj, HAPDomainEntityDefinitionLocal definitionDomain, HAPManagerDomainEntityDefinition domainEntityManager) {
		...
		HAPEmbededDefinitionWithId attachmentEntity = HAPUtilityParserEntity.parseEmbededEntity(attachmentJsonObj, HAPConstantShared.RUNTIME_RESOURCE_TYPE_ATTACHMENT, new HAPContextParser(definitionDomain, complexEntityInfo.getBaseLocationPath()), domainEntityManager);
