...
public class ParserValueMapping {

	public static List<HAPRootValueMapping> parseStructureRoots(Object rootsObj){
	...
	//parse context root
	public static HAPRootValueMapping parseStructureRootFromJson(JSONObject eleDefJson){
