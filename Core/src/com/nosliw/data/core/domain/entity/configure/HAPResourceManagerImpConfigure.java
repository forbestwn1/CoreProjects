...
public class HAPResourceManagerImpConfigure extends HAPResourceManagerImp{
	...
	public HAPResourceManagerImpConfigure(HAPManagerDomainEntityDefinition entityDefMan, HAPManagerResourceDefinition resourceDefMan, HAPResourceManagerRoot rootResourceMan) {
	...
	public HAPResource getResource(HAPResourceId resourceId, HAPRuntimeInfo runtimeInfo) {
		...
		HAPDefinitionEntityConfigure configureEntity = (HAPDefinitionEntityConfigure)entityDomain.getEntityInfoDefinition(resourceDef.getEntityId()).getEntity();
