...
public class HAPDefinitionInteractiveRequestParm extends HAPEntityInfoWritableImp{
	...
	public static HAPDefinitionInteractiveRequestParm buildUndefinedVariableInfo() {
		return buildVariableInfo(null);
	}
	
	public static HAPDefinitionInteractiveRequestParm buildVariableInfoFromObject(Object def) {
		HAPDefinitionInteractiveRequestParm out = new HAPDefinitionInteractiveRequestParm();
		out.buildObject(def, null);
		return out;
	}

	public static HAPDefinitionInteractiveRequestParm buildVariableInfo(HAPDataTypeCriteria criteria) {
		return buildVariableInfo(null, criteria);
	}

	public static HAPDefinitionInteractiveRequestParm buildVariableInfo(String name, HAPDataTypeCriteria criteria) {
		HAPDefinitionInteractiveRequestParm out = new HAPDefinitionInteractiveRequestParm();
	...
	protected HAPDefinitionInteractiveRequestParm() {
	...
	public boolean equals(Object obj){
		boolean out = false;
		if(obj instanceof HAPDefinitionInteractiveRequestParm){
			HAPDefinitionInteractiveRequestParm varInfo = (HAPDefinitionInteractiveRequestParm)obj;
	...
	public HAPDefinitionInteractiveRequestParm cloneVariableInfo() {
		HAPDefinitionInteractiveRequestParm out = new HAPDefinitionInteractiveRequestParm();
	...
	public void cloneToVariableInfo(HAPDefinitionInteractiveRequestParm varInfo) {
