...
public class HAPReferenceRootInMapping extends HAPSerializableImp implements HAPReferenceRoot{
	...
	@Override
	public HAPReferenceRoot cloneStructureRootReference() {   return new HAPReferenceRootInMapping(this.m_name);  }
}
