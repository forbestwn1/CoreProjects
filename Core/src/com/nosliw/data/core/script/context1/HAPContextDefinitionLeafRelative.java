...
public class HAPContextDefinitionLeafRelative extends HAPSerializableImp{
	...
	//child node
	private Map<String, HAPContextDefinitionLeafRelative> m_children;
	...
	public HAPContextDefinitionLeafRelative(){
		this.m_children = new LinkedHashMap<String, HAPContextDefinitionLeafRelative>();
	}
	...
	public Map<String, HAPContextDefinitionLeafRelative> getChildren(){	return this.m_children;	}
	
	public void addChild(String name, HAPContextDefinitionLeafRelative nodeBranch){		this.m_children.put(name, nodeBranch);	}
	
	public void toContextNode(HAPContextDefinitionLeafRelative node) {
		if(this.m_definition!=null)		node.m_definition = this.m_definition.clone();
		for(String childName : this.m_children.keySet()) {
			HAPContextDefinitionLeafRelative newNode = new HAPContextDefinitionLeafRelative();
