...
public class HAPContextUtility {
	...
	private static HAPContextNodeRoot processInheritedElement(HAPContextGroup parentContextGroup, String contextCategary, String eleName, HAPConfigureContextProcessor configure, HAPEnvContextProcessor contextProcessorEnv) {
		...
		if(HAPConstant.UIRESOURCE_ROOTTYPE_CONSTANT.equals(parentEle.getType())) {
			...
			outEle = HAPContextUtility.processRelativeContextDefinitionElement(eleName, relativeEle, parentContextGroup, configure, contextProcessorEnv);
		}
		return outEle;
	}
	...
	private static void processContextDefinition(HAPContext context, String contextCategary, HAPContextGroup parentContextGroup, HAPContext outContext, HAPConfigureContextProcessor configure, Map<String, Object> constants, HAPEnvContextProcessor contextProcessorEnv) {
