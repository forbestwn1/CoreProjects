...
public class HAPRequirementContextProcessor {
	...
	public HAPRequirementContextProcessor(HAPDataTypeHelper dataTypeHelper, HAPRuntime runtime, HAPExpressionSuiteManager expressionManager, Set<String> inheritanceExcludedInfo) {
