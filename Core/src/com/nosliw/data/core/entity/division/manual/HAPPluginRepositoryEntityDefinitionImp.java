...
public abstract class HAPPluginRepositoryEntityDefinitionImp implements HAPPluginRepositoryEntityDefinition{
	...
	public HAPPluginRepositoryEntityDefinitionImp(HAPIdEntityType entityTypeId, Class<? extends HAPManualEntity> entityClass) {
		this.m_entityTypeId = entityTypeId;
		this.m_entityClass = entityClass;
	}
	
	@Override
	public HAPIdEntityType getEntityType() {
		return this.m_entityTypeId;
	}

	@Override
	public HAPManualEntity retrieveEntityDefinition(HAPIdEntity entityId) {
	...
	protected void parseEntityAttributeSelf(HAPManualEntity parentEntity, JSONObject attrEntityObj, String attributeName, HAPIdEntityType entityTypeIfNotProvided, HAPIdEntityType adapterTypeId, HAPContextParse parserContext, HAPManagerEntityDivisionManual manualDivisionEntityMan, HAPManagerEntity entityManager) {
	...
	protected void parseSimpleEntityAttributeSelfJson(HAPManualEntity parentEntity, JSONObject attrEntityObj, String attributeName, HAPIdEntityType entityTypeIfNotProvided, HAPIdEntityType adapterTypeId, HAPContextParse parserContext, HAPManagerEntityDivisionManual manualDivisionEntityMan, HAPManagerEntity entityManager) {
		if(isAttributeEnabledJson(attrEntityObj)) {
			HAPManualAttribute attribute = HAPUtilityParserEntityFormatJson.parseAttribute(attributeName, attrEntityObj, entityTypeIfNotProvided, adapterTypeId, parserContext, manualDivisionEntityMan, entityManager);
			parentEntity.setAttribute(attribute);
