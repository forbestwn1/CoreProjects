...
public class HAPPluginParserEntityImp implements HAPPluginParserEntity{
	...
	public HAPPluginParserEntityImp(HAPIdEntityType entityTypeId, Class<? extends HAPManualEntity> entityClass, HAPManagerEntityDivisionManual manualDivisionEntityMan, HAPRuntimeEnvironment runtimeEnv) {
	...
	protected HAPManagerEntity getEntityManager() {    return this.getRuntimeEnvironment().getEntityManager();     }
	...
	protected void parseSimpleEntityAttributeSelfJson(HAPManualEntity parentEntityDefinition, JSONObject attrEntityObj, String attributeName, HAPIdEntityType attrEntityType, HAPIdEntityType adapterType, HAPContextParse parseContext, HAPManagerEntityDivisionManual manualDivisionEntityMan, HAPManagerEntity entityManager) {
		if(isAttributeEnabledJson(attrEntityObj)) {
			...
			parentEntityDefinition.setAttribute(attributeName, attributeEntity, new HAPInfoEntityType(attrEntityType, false));
