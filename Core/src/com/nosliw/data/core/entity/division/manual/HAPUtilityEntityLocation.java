...
public class HAPUtilityEntityLocation {
	...
	public static HAPInfoEntityLocation getEntityLocationInfo(HAPIdEntity entityId) {
		return getEntityLocationInfo(HAPSystemFolderUtility.getManualEntityBaseFolder(), entityId);
	}

	public static HAPInfoEntityLocation getLocalEntityLocationInfo(String basePath, HAPIdEntity entityId) {
		return getEntityLocationInfo(basePath, entityId);
	}

	private static HAPInfoEntityLocation getEntityLocationInfo(String basePath, HAPIdEntity entityId) {
		HAPIdEntityType entityTypeId = entityId.getEntityTypeId(); 
