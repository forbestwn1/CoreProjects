...
import com.nosliw.data.core.domain.entity.dataassociation.HAPExecutableGroupDataAssociationForTask;
...
public class HAPExecutableCommand extends HAPExecutableImpEntityInfo{
	...
	protected void buildJsonMap(Map<String, String> jsonMap, Map<String, Class<?>> typeJsonMap) {
		...
		if(this.m_dataAssociations!=null)   jsonMap.put(DATAASSOCIATION, HAPUtilityJson.buildJson(this.m_dataAssociations, HAPSerializationFormat.JSON));
		jsonMap.put(COMMAND, HAPUtilityJson.buildJson(this.m_command, HAPSerializationFormat.JSON));
	}
