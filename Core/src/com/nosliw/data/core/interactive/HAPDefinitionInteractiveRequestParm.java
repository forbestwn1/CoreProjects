...
public class HAPDefinitionInteractiveRequestParm extends HAPEntityInfoWritableImp{
	...
	public static HAPDefinitionInteractiveRequestParm buildParmFromObject(Object def) {
		HAPDefinitionInteractiveRequestParm out = new HAPDefinitionInteractiveRequestParm();
		out.buildObject(def, null);
		return out;
	}

	public static HAPDefinitionInteractiveRequestParm buildParm(HAPDataTypeCriteria criteria) {
		return buildParm(null, criteria);
	}

	public static HAPDefinitionInteractiveRequestParm buildParm(String name, HAPDataTypeCriteria criteria) {
		HAPDefinitionInteractiveRequestParm out = new HAPDefinitionInteractiveRequestParm();
