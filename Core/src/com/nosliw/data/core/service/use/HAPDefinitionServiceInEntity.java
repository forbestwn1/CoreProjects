...
public class HAPDefinitionServiceInEntity extends HAPSerializableImp{
	...
	protected void buildJsonMap(Map<String, String> jsonMap, Map<String, Class<?>> typeJsonMap) {
		...
		jsonMap.put(USE, HAPJsonUtility.buildJson(this.m_servicesUseDefinition, HAPSerializationFormat.JSON));
		jsonMap.put(PROVIDER, HAPJsonUtility.buildJson(this.m_servicesProviderDefinition, HAPSerializationFormat.JSON));
	}
