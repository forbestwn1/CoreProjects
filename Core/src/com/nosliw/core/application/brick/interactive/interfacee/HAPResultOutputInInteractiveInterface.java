...
public class HAPResultOutputInInteractiveInterface extends HAPEntityInfoWritableImp{
	...
	public HAPResultOutputInInteractiveInterface() {}

	public HAPResultOutputInInteractiveInterface(HAPDataTypeCriteria criteria) {
	...
	public HAPResultOutputInInteractiveInterface cloneInteractiveOutput() {
		HAPResultOutputInInteractiveInterface out = new HAPResultOutputInInteractiveInterface();
