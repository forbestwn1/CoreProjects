...
public class HAPWrapperValueInAttributeEntity extends HAPWrapperValueInAttribute implements HAPWithBrick{

	private HAPBrick m_entity;
	
	private HAPIdBrickType m_entityTypeId;
	
	public HAPWrapperValueInAttributeEntity(HAPBrick entity) {
	...
	protected void buildJsonMap(Map<String, String> jsonMap, Map<String, Class<?>> typeJsonMap){
		...
		jsonMap.put(ENTITY, this.getBrick().toStringValue(HAPSerializationFormat.JSON));
	}

	@Override
	protected void buildResourceJsonMap(Map<String, String> jsonMap, Map<String, Class<?>> typeJsonMap, HAPRuntimeInfo runtimeInfo){
		this.buildJsonMap(jsonMap, typeJsonMap);
		jsonMap.put(ENTITY, this.getBrick().toResourceData(runtimeInfo).toString());
	}
