...
public class HAPUtilityParserEntityFormatJson {
	...
	public static HAPManualInfoEntity parseEntityInfo(JSONObject jsonObj, HAPIdBrickType entityTypeIfNotProvided, HAPContextParse parseContext, HAPManagerEntityDivisionManual manualDivisionEntityMan, HAPManagerApplicationBrick entityManager) {
	...
	public static HAPManualAttribute parseAttribute(String attrName, JSONObject jsonObj, HAPIdBrickType entityTypeIfNotProvided, HAPIdBrickType adapterTypeId, HAPContextParse parseContext, HAPManagerEntityDivisionManual manualDivisionEntityMan, HAPManagerApplicationBrick entityManager) {
	...
	public static HAPManualInfoAttributeValue parseAttributeValueInfo(JSONObject jsonObj, HAPIdBrickType entityTypeIfNotProvided, HAPContextParse parseContext, HAPManagerEntityDivisionManual manualDivisionEntityMan, HAPManagerApplicationBrick entityManager) {
		...
		if(out==null) {
			...
			if(entityRefObj!=null) {
				HAPIdBrick entityId = HAPUtilityEntity.parseEntityIdAgressive(entityRefObj, parseContext.getEntityDivision(), entityManager); 
	...
	private static HAPIdBrickType parseEntityTypeId(Object entityTypeObj, HAPIdBrickType entityTypeIfNotProvided, HAPManagerApplicationBrick entityManager) {
		...
		if(entityTypeObj!=null) {
			HAPIdBrickType entityTypeId1 = HAPUtilityDefinitionEntity.parseEntityTypeId(entityTypeObj);
	...
	private static HAPManualEntity parseLocalValue(String basePath, HAPIdBrick entityId, HAPManagerEntityDivisionManual manualDivisionEntityMan) {
	...
	private static List<HAPManualInfoAdapter> parseAdapter(Object adaptersObj, HAPIdBrickType adatperTypeId, HAPManagerEntityDivisionManual textDivisionEntityMan, HAPManagerApplicationBrick entityManager){
