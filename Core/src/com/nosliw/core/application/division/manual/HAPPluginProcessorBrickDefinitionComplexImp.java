...
public abstract class HAPPluginProcessorBrickDefinitionComplexImp implements HAPPluginProcessorBrickDefinitionComplex{

	private Class<? extends HAPBrickComplex> m_exeBrickClass;
	
	private HAPIdBrickType m_brickTypeId;
	
	public HAPPluginProcessorBrickDefinitionComplexImp(HAPIdBrickType entityType, Class<? extends HAPBrickComplex> exeBrickClass) {
