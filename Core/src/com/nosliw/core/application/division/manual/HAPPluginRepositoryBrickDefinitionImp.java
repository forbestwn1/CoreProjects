...
public abstract class HAPPluginRepositoryBrickDefinitionImp implements HAPPluginRepositoryBrickDefinition{

	private Class<? extends HAPManualBrick> m_entityClass;

	private HAPIdBrickType m_brickTypeId;
	
	public HAPPluginRepositoryBrickDefinitionImp(HAPIdBrickType entityTypeId, Class<? extends HAPManualBrick> entityClass) {
