...
public abstract class HAPPluginProcessorBrickDefinitionSimpleImp implements HAPPluginProcessorBrickDefinitionSimple{

	private Class<? extends HAPExecutableEntity> m_exeEntityClass;
	
	private String m_entityType;

	public HAPPluginProcessorBrickDefinitionSimpleImp(String entityType, Class<? extends HAPExecutableEntity> exeEntityClass) {
