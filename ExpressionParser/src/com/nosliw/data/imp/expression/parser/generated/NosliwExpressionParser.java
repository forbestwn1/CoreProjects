...
operation parm
*/
  final public SimpleNode DataTypeName() throws ParseException {/*@bgen(jjtree) DATATYPENAME */
...
jjtree.closeNodeScope(jjtn000, true);
          jjtc000 = false;
jjtn000.value=value;   {if ("" != null) return jjtn000;}
    } finally {
if (jjtc000) {
            jjtree.closeNodeScope(jjtn000, true);
          }
...
*/
  final public SimpleNode DataType() throws ParseException {/*@bgen(jjtree) DATATYPE */
...
*/
  final public void ParmName() throws ParseException {/*@bgen(jjtree) PARMNAME */
...
operation parm
*/
  final public SimpleNode Parameter(String index) throws ParseException {/*@bgen(jjtree) PARAMETER */
...
*/
  final public SimpleNode Expression(String index) throws ParseException {/*@bgen(jjtree) EXPRESSION */
...
*/
  final public SimpleNode Expression1() throws ParseException {/*@bgen(jjtree) EXPRESSION1 */
