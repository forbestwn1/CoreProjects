...
public class HAPQueryComponentSimple extends HAPQueryComponent{
	...
	public HAPEntityOperationInfo newEntity(HAPEntityWraper entity){
		...
		if(m_revalidation==true){
			...
			if(queryEntityWraper!=null){
				operation = this.addQueryEntityOperation(queryEntityWraper, HAPConstant.CONS_ENTITYOPERATION_SCOPE_GLOBAL);
			}
		}
		return operation;
	}
	...
	public HAPEntityOperationInfo deleteEntity(HAPEntityID ID){
		return this.removeQueryEntityOperation(ID.toString(), HAPConstant.CONS_ENTITYOPERATION_SCOPE_GLOBAL);
	}
	...
	public HAPEntityOperationInfo changeEntity(HAPEntityWraper entity){
		...
		if(queryEntityWraper==null){
			...
			return this.addOrUpdateQueryEntityOperation(queryEntityWraper, HAPConstant.CONS_ENTITYOPERATION_SCOPE_GLOBAL);
		}
	}	
}
