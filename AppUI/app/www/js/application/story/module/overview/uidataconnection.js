...
var node_createUIDataConnectionLink = function(uiNodeId, parentContextDef, module){
	...
	var loc_init = function(){
		...
		if(storyUINodeType==node_COMMONCONSTANT.STORYNODE_TYPE_UIDATA){
			var contextPath = storyUINode[node_COMMONATRIBUTECONSTANT.STORYNODEUIDATA_DATAINFO][node_COMMONATRIBUTECONSTANT.UIDATAINFO_IDPATH];
			var rootReference = storyUINode[node_COMMONATRIBUTECONSTANT.STORYNODEUIDATA_DATAINFO][node_COMMONATRIBUTECONSTANT.UIDATAINFO_ROOTREFERENCE];
