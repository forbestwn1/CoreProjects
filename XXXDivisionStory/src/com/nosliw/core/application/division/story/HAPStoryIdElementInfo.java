...
public class HAPStoryIdElementInfo extends HAPSerializableImp{
	...
	public HAPStoryIdElementInfo() {}
	
	public HAPStoryIdElementInfo(String categary, String type, String id) {
